...
const projectsDetail = [
  {
    ...
    description:
      "This website is my portfolio website made using Next.js. It also has a 3D model integrated with Three.js. Also used NextUI for the UI components.",
    icons: [
      "https://img.icons8.com/color/480/react-native.png",
      "https://img.icons8.com/color/480/nextjs.png",
  ...
  },
  {
    ...
    description:
      "Multiplayer 2D game. C++ and OpenGL. Different levels, leaderboard, and single-player mode against the computer. Exciting classic gaming experience.",
    icons: [
  ...
  },
  {
    ...
    description:
      "A C# Windows Form Application that allows teachers to create courses, assignments, and quizzes. Students can join courses and submit assignments.",
    icons: [
      "https://img.icons8.com/color/480/c-sharp-logo-2.png",
      "https://img.icons8.com/color/480/google-classroom.png",
  ...
  },
  {
    ...
    description:
      "A Java and JavaFX Application that allows residents to submit complaints and track their status. Admins can assign complaints to workers and track their progress.",
    icons: [
      "https://img.icons8.com/color/480/java-coffee-cup-logo.png",
      //JavaFX
      ...
      >
        ...
        <div className={styles.MainHeading}>
          ...
          <h5>
            ...
            Writing SQL Queries, JavaFX applications. Below are some of my
            projects. Note that not all of the mentioned projects are on GitHub
            yet.
          </h5>
        </div>
      </section>
